...
plot(sentiment_airplane_video$`120`
     ...
     , col = ifelse(sentiment_airplane_video$`120` > 0, 'blue', 'red'))
...
plot(sentiment_airplane_video_unscaled$`120`
     , type='h'
     , ylim = c(0, .4)
     , main = 'THE $21,000 FIRST CLASS AIRPLANE SEAT'
     , ylab = 'Sentiment raw'
     , xlab = 'Standardized narrative time'
     , col = ifelse(sentiment_airplane_video_unscaled$`120` > 0, 'blue', 'red'))
