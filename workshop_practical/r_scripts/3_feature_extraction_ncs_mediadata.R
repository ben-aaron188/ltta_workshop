...
setwd('/Users/bennettkleinberg/GitHub/ltta_workshop/data_media_channels/loop_run_ncs')
...
save(dt.data_sentiment
     , file='/Users/bennettkleinberg/Dropbox/workshop_eurocss/hackathon_data/features/eurocss_mediadata_sentiment.RData')
